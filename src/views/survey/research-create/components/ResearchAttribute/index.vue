    ...
    <el-card shadow="hover" style="margin: 5px">
      <el-tabs type="card" v-model="activeTabName">
        <el-tab-pane label="组件属性" name="controlProperties">
          <el-form v-if="editIndex !== null" label-width="80px" size="small">
            <h4 style="padding: 10px; text-align: center">组件基本属性</h4>
            ...
            <!-- 扩展配置 -->
            <h4
              v-if="editFactor === 'switch' || editFactor === 'textarea'"
            ...
            <el-form-item v-if="editFactor === 'switch'" label="关闭值">
              <el-input
                placeholder="请输入关闭值"
                v-model="research.detail[editIndex].inactiveValue"
                clearable
              ></el-input>
            </el-form-item>
            <div
              ...
              "
            >
              <h4 style="padding: 10px; text-align: center">选项</h4>
              <div
                v-for="(option, index) in research.detail[editIndex].options"
                :key="index"
                class="options"
              >
                ...
                <el-input
                  placeholder="选项名"
                  v-model="research.detail[editIndex].options[index].label"
                  size="small"
                  style="margin: 0 5px"
                ></el-input>
                <el-input
                  placeholder="选项值"
                  v-model="research.detail[editIndex].options[index].value"
                  size="small"
                  style="margin: 0 5px"
                ></el-input>
                <el-button
            ...
            <div v-if="editFactor !== 'switch'">
              <h4 style="padding: 10px; text-align: center">组件验证规则</h4>
              <el-form-item label="是否必填">
                <el-switch
                  v-model="research.rules[editFieldId][0].required"
                ></el-switch>
              </el-form-item>
              <el-form-item label="规则提示">
                <el-input
                  placeholder="输入内容"
                  v-model="research.rules[editFieldId][0].message"
                  clearable
                ></el-input>
              </el-form-item>
            </div>
            <h4 style="padding: 10px; text-align: center">更多</h4>
